...
def generate_pizdato_meme():
    nachalo = [
        ...
        "Ну ты понял", "Все ясно,", "Тема жжот", "Бывает", "Хуй пизда джигурда", "Смех смехом",
        "Забей", "Лисен ту ми"
    ]
    
    seredina = [
        "все будет", "жизнь есть", "деньги придут", "девки текут", "мемы крутят",
        "дело пойдет", "халява ловится", "везение прилетает", "приколы идут",
        "настроение поднимается", "друзья набираются", "кифас растет",
        "план срабатывает", "система работает", "драйв появляется",
        "энергия бьет ключом", "удача улыбается", "все складывается",
        "звезды сходятся", "карма благоволит", "вселенная помогает"
    ]
    ...
    konec = [
        ...
        "в стиле боос", "с разгону", "на отлично", "как в аниме",
        "по-настоящему", "в полный рост", "и идёт по пизде"
    ]
