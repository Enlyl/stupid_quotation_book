...
def generate_pizdato_meme():
    nachalo = [
        ...
        "Не спорь,", "Поверь,", "Смотри сюда,", "Вообще тема,","Рот ставлю,",
    ...
    seredina = [
        "всё будет", "жизнь есть", "деньги придут", "девки текут", "мемы крутятся",
        "дело пойдет", "халява ловится", "везение прилетает", "приколы идут",
        "настроение поднимается", "друзья напиваются", "биток растёт","два шага назад и ещё щаг назад",
        "план срабатывает", "система работает", "драйв появляется", "ночь светлее дня", "щекотка щекотит",
        "энергия бьёт ключом", "удача улыбается", "всё складывается", "хлюпает в кедах",
        "звёзды сходятся", "карма благоволит", "вселенная помогает", "лавэ мутится", "писюн опускается"
    ]
    
    konec = [
        "четко", "в натуре", "без леща", "по-пацански", "в топку",
        "на ура", "как по маслу", "в кайф", "по-максимуму", "на полную",
        "с первого раза", "без вопросов", "как надо", "по красоте", "в жопу",
